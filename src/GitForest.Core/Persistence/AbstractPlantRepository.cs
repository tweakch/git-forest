...
/// </summary>
public abstract class AbstractPlantRepository : AbstractRepositoryWithSpecs<Plant, string>, IPlantRepository
{
    ...
    public abstract override Task<Plant?> GetByIdAsync(string id, CancellationToken cancellationToken = default);
    public abstract override Task AddAsync(Plant entity, CancellationToken cancellationToken = default);
    public abstract override Task UpdateAsync(Plant entity, CancellationToken cancellationToken = default);
    public abstract override Task DeleteAsync(Plant entity, CancellationToken cancellationToken = default);
