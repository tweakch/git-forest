    ...
    where T : class
{
    ...
    private async Task<TResult?> GetBySpecInternalAsync<TResult>(
        ISpecification<T, TResult> specification,
    ...
    private async Task<T?> GetBySpecInternalAsync(
        ISpecification<T> specification,
        CancellationToken cancellationToken
    )
    {
    ...
    private async Task<IReadOnlyList<TResult>> ListBySpecInternalAsync<TResult>(
        ISpecification<T, TResult> specification,
        CancellationToken cancellationToken
    )
    {
    ...
    private async Task<IReadOnlyList<T>> ListBySpecInternalAsync(
        ISpecification<T> specification,
        CancellationToken cancellationToken
    )
    {
