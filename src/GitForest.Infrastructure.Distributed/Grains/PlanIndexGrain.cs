...
/// <summary>
/// Index grain implementation for tracking Plan IDs
/// </summary>
public class PlanIndexGrain : Grain, IPlanIndexGrain
{
    private readonly IPersistentState<HashSet<string>> _state;

    public PlanIndexGrain([PersistentState("planIndex")] IPersistentState<HashSet<string>> state)
    {
        _state = state;
    }
