...
/// <summary>
/// Index grain implementation for tracking Plant IDs
/// </summary>
public class PlantIndexGrain : Grain, IPlantIndexGrain
{
    private readonly IPersistentState<HashSet<string>> _state;

    public PlantIndexGrain([PersistentState("plantIndex")] IPersistentState<HashSet<string>> state)
    {
        _state = state;
    }
